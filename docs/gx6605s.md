...
* 内核和根文件系统都是放在U盘里，SPI Flash 中的内置bootloader会自动检测并引导Linux.

准备U盘，从 gitlab/c-sky 上下载 [usb.img](https://gitlab.com/c-sky/buildroot/-/jobs/24633630/artifacts/raw/output/images/usb.img)，这是用buildroot编译好的镜像，默认 framebuffer 终端，烧录U盘参考以下命令．
